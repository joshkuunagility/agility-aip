...
**TL;DR:** AIPs are lots of documents on how Agility does APIs.
...
documentation at Agility and the way API teams discuss and come to consensus on
...
### Specific areas inside Agility

While much of the API-related guidance is general and spans across all the
different products at Agility, we've found that some teams working in different
...
[frequently asked questions]: https://agility.aip.dev/faq
